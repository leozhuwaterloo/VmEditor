#include "store.h"
#include <iostream>
Store::Store(std::list<std::string> strs):strs{strs}, currY{0}, numInvalid{0},displayedLine{0}{ itCurrY = getStrs().cbegin(); }
...
int Store::getDisplayedLine() const { return displayedLine; }
