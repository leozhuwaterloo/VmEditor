...
Highlighter::Highlighter(const std::regex &reg, const int &fontColor, const int &bgColor):reg{reg}, fontColor{fontColor}, bgColor{bgColor}{}
Highlighter::Highlighter(const std::regex &reg, const int &fontColor):Highlighter{reg, fontColor, COLOR_BLACK}{}
