...
class CommandCtrld: public Command {
public:
    CommandCtrld();
    virtual void run(Window *w) const override;
};

class CommandCtrlu: public Command {
public:
    CommandCtrlu();
    virtual void run(Window *w) const override;
};

class CommandCtrlb: public Command {
public:
    CommandCtrlb();
    virtual void run(Window *w) const override;
};
...
class CommandDot: public UndoableCommand {
public:
    CommandDot();
    virtual std::vector<std::unique_ptr<Event>> runEvent(Window *w) const override;
    virtual void reverseExecute(Window *w, Event *e) const override;
...
class Commandd: public UndoableCommand {
public:
    Commandd();
    virtual std::vector<std::unique_ptr<Event>> runEvent(Window *w) const override;
    virtual void reverseExecute(Window *w, Event *e) const override;
...
class Commandy: public UndoableCommand {
public:
    Commandy();
    virtual std::vector<std::unique_ptr<Event>> runEvent(Window *w) const override;
    virtual void reverseExecute(Window *w, Event *e) const override;
...
class Commands: public UndoableCommand {
public:
    Commands();
    virtual std::vector<std::unique_ptr<Event>> runEvent(Window *w) const override;
    virtual void reverseExecute(Window *w, Event *e) const override;
